...
class _NativeVolumeState extends State<NativeVolume> {
  ...
  if(lockScreen)  Fluttertoast.showToast(msg: "Your Screen Has been locked");
  if(!lockScreen)  Fluttertoast.showToast(msg: "Your Screen Has been Unlocked");
  }
